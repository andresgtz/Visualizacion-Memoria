...
- (void)setUpBookTitle
{
    ...
    //Ponerlo fuera de la pantalla
    bookTitle.position = CGPointMake(425,900);
    [self addChild:bookTitle];
    //Hacer que baje,suba poquito y baje, animacion que rebota
    //titulo
