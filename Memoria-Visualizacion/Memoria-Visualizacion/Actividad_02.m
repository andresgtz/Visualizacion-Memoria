...
-(void)setUpImages{
    ...
    title = [SKSpriteNode spriteNodeWithImageNamed:@"Actividad2"];
    title.position = CGPointMake(self.size.width/2 - 20, 700);
    [self addChild:title];
    
    
    instructions = [SKSpriteNode spriteNodeWithImageNamed:@"Act_2_ins"];
...
-(void)update:(CFTimeInterval)currentTime
{
    ...
    if((_enLugar >= 8)&& _gameMode8 ){
        ...
        else if(_address == 23 || _address == 24 || _address == 26 || _address == 27){
